        ...
        <div class="container mx-auto">
            ...
            <div class="mb-4">
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    <a href="MainEntryPoint.php?modul=barang&fitur=add">Insert New Barang</a>
                </button>
            </div>
                    ...
                    <tbody class="text-gray-700">
                        <?php foreach($obj_barang as $barang) { ?>
                            <tr class="text-center">
                                <td class="py-3 px-4 text-blue-600"><?php echo htmlspecialchars($barang->nama) ?></td>
                                <td class="w-1/4 py-3 px-4"><?php echo htmlspecialchars($barang->harga) ?></td>
